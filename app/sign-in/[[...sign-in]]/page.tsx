...
export default function SignInPage() {
  return (
    <div className="min-h-screen bg-[#070921] text-white flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#5865f2]/15 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-[350px] h-[350px] bg-[#00b0f4]/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="mb-6 flex flex-col items-center gap-2">
        ...
        <p className="text-xs text-zinc-400 font-mono">Sign in to sync your fitness command hub</p>
      </div>
      ...
      <SignIn
        appearance={{
          elements: {
            ...
            formButtonPrimary:
              "bg-[#5865f2] hover:bg-[#4752c4] text-white text-xs font-bold font-mono tracking-wider uppercase py-3 rounded-xl shadow-[0_0_20px_rgba(88,101,242,0.4)] transition-all active:scale-[0.99]",
            formFieldInput:
              "bg-[#070a24] border-white/15 text-white placeholder:text-zinc-500 rounded-xl text-xs font-mono py-2.5 focus:border-[#5865f2]",
