    ...
    <div className="container py-20">
      ...
      <div className="flex justify-center items-center mb-10">
        <div className="relative inline-flex items-center cursor-pointer">
          <Label htmlFor="pricing-switch" className="sr-only">Toggle annual billing</Label>
          <Switch
            id="pricing-switch"
            ref={switchRef}
            checked={!isMonthly}
            ...
            <div className="flex-1 flex flex-col">
              ...
              <Link
                ...
                className={cn(
                  ...
                  "group relative w-full gap-2 overflow-hidden text-base font-semibold tracking-normal",
